...
public sealed class ZadaniaLinq
{
    ...
    {
        bool exists = DaneUczelni.Zapisy
            .Any(z => !z.CzyAktywny);

        return new[] { exists.ToString() };
    }
    ...
    {
        bool all = DaneUczelni.Prowadzacy
            .All(p => p.Katedra != null);

        return new[] { all.ToString() };
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Przedmioty,
                g => g.Key,
                p => p.Id,
                (g, p) => $"{p.Nazwa} {g.Average(z => z.OcenaKoncowa)}");
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Studenci,
                g => g.Key,
                s => s.Id,
                (g, s) => $"{s.Imie} {s.Nazwisko} {g.Max(z => z.OcenaKoncowa)}");
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            ...
            .Select(x =>
                $"{x.pr.Imie} {x.pr.Nazwisko} {x.zapisy.Where(z => z.OcenaKoncowa != null).DefaultIfEmpty().Average(z => z?.OcenaKoncowa ?? 0)}");
    }
